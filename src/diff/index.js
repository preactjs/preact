...
export function diff(dom, parentDom, newVNode, oldVNode, context, isSvg, append, excessDomChildren, mounts, ancestorComponent, parentVNode) {
	...
	try {
		...
		outer: if (isOldVNodeFragment || newType === Fragment) {
			...
			diffChildren(parentDom, getVNodeChildren(newVNode), oldVNodeChildren, context, isSvg, excessDomChildren, mounts, c, newVNode, excessDomChildren != null ? excessDomChildren[0] : oldVNode._dom);
