...
describe('Fragment', () => {
	...
	it('should support conditionally rendered Fragment', () => {
		...
		expectDomLogToBe(
			[
				'<li>.insertBefore(#text, Null)',
				'<ol>0121.insertBefore(<li>2, Null)',
				'<li>.insertBefore(#text, Null)',
				'<ol>01212.insertBefore(<li>3, Null)',
				'<li>1.remove()',
				'<li>2.remove()'
			],
	...
	it('should support conditional beginning and end Fragments', () => {
		...
		expectDomLogToBe([
			// Mount 3 & 4
			'<li>.insertBefore(#text, Null)',
			'<ol>0122.insertBefore(<li>3, Null)',
			'<li>.insertBefore(#text, Null)',
			'<ol>01223.insertBefore(<li>4, Null)',
