...
describe('Fragment', () => {
	...
	it('should not preserve state in non-top-level fragment nesting', () => {
		...
		expectDomLogToBe([
			'<div>Hello.remove()',
			'<div>.insertBefore(#text, Null)',
			'<div>.insertBefore(<div>Hello, Null)'
		]);
	...
	it('should preserve state with reordering in multiple levels', () => {
		...
		expectDomLogToBe(
			[
				'<div>barHellobeep.insertBefore(<div>bar, Null)',
				'<div>Hellobeepbar.insertBefore(<div>Hello, Null)',
		...
		expectDomLogToBe(
			[
				'<div>beepHellofoo.insertBefore(<div>Hello, Null)',
				'<div>boopfooHello.insertBefore(<div>boop, Null)'
			],
	...
	it('should render nested Fragments', () => {
		...
		expectDomLogToBe([
			'<div>.insertBefore(#text, Null)',
			'<div>spam.insertBefore(#text, Null)',
			'<div>spamfoo.insertBefore(#text, Null)'
		]);
		...
		expectDomLogToBe([
			'#text.remove()',
			'#text.remove()',
			'<div>foo.insertBefore(#text, Null)'
		]);
	});
	...
	it('should support conditionally rendered Fragment', () => {
		...
		expectDomLogToBe(
			[
				...
				'<ol>.insertBefore(<li>0, Null)',
				'<li>.insertBefore(#text, Null)',
				'<ol>0.insertBefore(<li>1, Null)',
				'<li>.insertBefore(#text, Null)',
				'<ol>01.insertBefore(<li>2, Null)',
				'<li>.insertBefore(#text, Null)',
				'<ol>012.insertBefore(<li>3, Null)',
				'<div>.insertBefore(<ol>0123, Null)'
			],
	...
	it('should support conditionally rendered Fragment or null', () => {
		...
		expectDomLogToBe(
			[
				...
				'<ol>012.insertBefore(<li>3, Null)',
				'<li>.insertBefore(#text, Null)',
				'<ol>0123.insertBefore(<li>4, Null)',
				'<div>.insertBefore(<ol>01234, Null)'
			],
			'initial render of true'
		);
	...
	it('should support moving Fragments between beginning and end', () => {
		...
		// A perfect algo can do this in two moves
		// expectDomLogToBe([
		// 	'<ol>012345.insertBefore(<li>4, <li>0)',
		// 	'<ol>401235.insertBefore(<li>5, <li>0)'
		// ]);
		expectDomLogToBe([
			'<ol>012345.insertBefore(<li>0, Null)',
			'<ol>123450.insertBefore(<li>1, Null)',
			'<ol>234501.insertBefore(<li>2, Null)',
		...
		expectDomLogToBe([
			'<ol>450123.insertBefore(<li>4, Null)',
			'<ol>501234.insertBefore(<li>5, Null)'
		]);
	});
	...
	it('should support conditional beginning and end Fragments', () => {
		...
		expectDomLogToBe([
			...
			// Mount 3 & 4
			'<li>.insertBefore(#text, Null)',
			'<ol>22.insertBefore(<li>3, Null)',
			'<li>.insertBefore(#text, Null)',
			'<ol>223.insertBefore(<li>4, Null)'
		]);
	...
	it('should support nested conditional beginning and end Fragments', () => {
		...
		expectDomLogToBe([
			...
			// Mount 4 & 5
			'<li>.insertBefore(#text, Null)',
			'<ol>23.insertBefore(<li>4, Null)',
			'<li>.insertBefore(#text, Null)',
			'<ol>234.insertBefore(<li>5, Null)'
		]);
	...
	it('should preserve state with reordering in multiple levels with lots of Fragment siblings', () => {
		...
		expectDomLogToBe(
			[
				'<div>barHellobeepbeepbeep.insertBefore(<div>bar, Null)',
				'<div>Hellobeepbeepbeepbar.insertBefore(<div>Hello, Null)',
				'<div>beepbeepbeepbarHello.insertBefore(<div>bar, Null)'
			],
			'rendering from true to false'
		);
		...
		expectDomLogToBe(
			...
			[
				'<div>beepbeepbeepHellofoo.insertBefore(<div>Hello, Null)',
				'<div>boopbeepbeepfooHello.insertBefore(<div>boop, Null)',
				'<div>boopbeepfooHelloboop.insertBefore(<div>boop, Null)',
	...
	it('should correctly append children with siblings', () => {
		/**
		 * @type {(props: { values: Array<string | number>}) => preact.VNode<any>}
		 */
		const Foo = ({ values }) => (
			<ol>
				<li>a</li>
	...
	it('should render components that conditionally return Fragments', () => {
		...
		expectDomLogToBe(
			[
				...
				'#text.remove()',
				'<div>.insertBefore(#text, Null)',
				'<div>.insertBefore(<div>3, Null)',
				'<div>.insertBefore(#text, Null)',
				'<div>3.insertBefore(<div>4, Null)'
			],
			'rendering from true to false'
		);
	...
	it('should support conditionally rendered nested Fragments or null with siblings', () => {
		...
		expectDomLogToBe(
			[
				...
				'<ol>0123.insertBefore(<li>4, Null)',
				'<li>.insertBefore(#text, Null)',
				'<ol>01234.insertBefore(<li>5, Null)',
				'<div>.insertBefore(<ol>012345, Null)'
			],
			'initial render of true'
		);
	...
	it('should properly render Fragments whose last child is a component returning null', () => {
		...
		expectDomLogToBe([
			'<div>.insertBefore(#text, Null)',
			'<div>.insertBefore(<div>A, Null)',
			'<div>.insertBefore(#text, Null)',
			'<div>A.insertBefore(<div>B, Null)',
			'<div>.insertBefore(#text, Null)',
			'<div>AB.insertBefore(<div>C, Null)'
		]);
	});
	...
	it('should replace node in-between children', () => {
		...
		expectDomLogToBe([
			'<div>B1.remove()',
			'<section>.insertBefore(#text, Null)',
	...
	it('should correctly append children if last child changes DOM', () => {
		...
		expectDomLogToBe([
			...
			'<div>A2.remove()',
			'<span>.insertBefore(#text, Null)',
			'<div>.insertBefore(<span>A3, Null)',
			'<span>.insertBefore(#text, Null)',
			'<div>A3.insertBefore(<span>A4, Null)'
		]);
		...
		expectDomLogToBe([
			'<div>.insertBefore(#text, Null)',
			'<div>A3A4.insertBefore(<div>B, Null)'
		]);
	});
	...
	it('should properly place conditional elements around strictly equal vnodes', () => {
		...
		expectDomLogToBe([
			...
			'<div>.insertBefore(#text, Null)',
			'<div>NavigationContent.insertBefore(<div>bottom panel, Null)'
		]);
