...
const CAMEL_PROPS = /^(?:accent|alignment|arabic|baseline|cap|clipPathUnits|scolor|fill|flood|font|glyph|horiz|marker|overline|paint|stop|strikethrough|stroke|text|underline|unicode|units|v|vector|vert|word|writing|x)[A-Z]/;
